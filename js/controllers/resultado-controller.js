angular.module('simulado').controller('ResultadoController', function ($scope) {
    ...
    var arrayTest = $scope.tabela;
    var arrayMetade = arrayTest.slice(0, 7);
    var outraMetade = arrayTest.slice(7, 14);

    $scope.tabela = arrayMetade;

    $scope.loadMorePage = function () {

        $scope.$watch('tabela', function (newVal, oldVal) {
            $scope.tabela = outraMetade;
            console.log("Outra metade > 7");
